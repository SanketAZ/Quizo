...
public class OptimusServiceClient {
    ...
    public QuizDetailCacheDTO getQuizDetails(UUID roomId,UUID quizId){
        try {
            return optimusClient.get()
                    .uri("/quiz/{quizId}/room/{roomId}/details",quizId,roomId)
                    .retrieve()
                    .body(QuizDetailCacheDTO.class);
        } catch (Exception e) {
    ...
    public QuestionCacheDTO getQuestionCache(UUID roomId,UUID quizId,UUID questionId){
        try {
            return optimusClient.get().uri("/quiz/{quizId}/room/{roomId}/question/{questionId}",quizId,roomId,questionId)
                    .retrieve()
                    .body(QuestionCacheDTO.class);
        } catch (Exception e) {
